...
namespace NPerf.Cons.Test
{
    ...
    //Main tests
    [PerfTester(typeof(IDateSorter), 15, Description = "Sort Algorithm benchmark for StartTimes and EndTimes", FeatureDescription = "Collection size")]
