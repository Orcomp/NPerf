namespace NPerf.Experiment.Basics
{
    ...
    public abstract class BasePerfTestSuite<T> : IPerfTestSuite
    {
        public IPerfTest[] Tests { get; protected set; }

        public IPerfLogger Logger { get; protected set; }

        public IPerfMonitor[] Monitors { get; protected set; }
        ...
        public void SetUp(int iteration, object testedObject)
        {
            ...
            Descriptor.Instance.Value = this.GetDescriptorMethod != null
                                            ? (long)this.GetDescriptorMethod(iteration)
                                            : iteration;
        }
